...
@XmlType(name = "Definition", namespace = "http://rebecalang.org/compiler/propertycompiler/generalproperty", propOrder = {
    "expression"
})
public class Definition {

    @XmlElement(name = "Expression", namespace = "http://rebecalang.org/compiler/propertycompiler/generalproperty", required = true)
