...
public class CoreRebecaPropertyCompleteParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'LTL'", "'Assertion'", "'define'", "'->'", "'property'", 
		...
		try {
			...
			if (_la==LTL) {
				...
				while (_la==IDENTIFIER) {
					...
					setState(74); ((PropertyDefinitionContext)_localctx).ltle = expression();
	...
	public static final String _serializedATN =
		...
		"\2\2\66\u01ce\3\2\2\289\7\4\2\29B\7\25\2\2:;\7?\2\2;<\7 \2\2<=\5\n\6\2"+
		...
		"\u01ca\3\2\2\2\u01cd\65\3\2\2\2\u01ce\u01cf\b\34\1\2\u01cf\u01d0\7\7\2"+
		"\2\u01d0\u01df\7\25\2\2\u01d1\u01d2\7\5\2\2\u01d2\u01db\7\25\2\2\u01d3"+
