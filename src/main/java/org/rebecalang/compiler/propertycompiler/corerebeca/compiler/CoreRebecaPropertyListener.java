...
public class CoreRebecaPropertyListener extends CoreRebecaPropertyCompleteBaseListener{
    ...
    public void exitPropertyDefinition(CoreRebecaPropertyCompleteParser.PropertyDefinitionContext ctx) {
        ...
        if (ctx.ltlBlock() != null)
            propertyModel.getLTLDefinitions().addAll(ctx.ltlBlock().ltls);
        ctx.pm = propertyModel;
    }
    ...
    @Override
    public void exitAnnotation(CoreRebecaPropertyCompleteParser.AnnotationContext ctx) {
    ...
    @Override
    public void exitType(CoreRebecaPropertyCompleteParser.TypeContext ctx) {
        Type type;
    ...
    @Override
    public void exitGenericTypeParams(CoreRebecaPropertyCompleteParser.GenericTypeParamsContext ctx) {
        List<Type> genericTypeParams = new LinkedList<>();
        for (CoreRebecaPropertyCompleteParser.TypeContext typeContext : ctx.type()) {
    ...
    @Override
    public void exitDimensions(CoreRebecaPropertyCompleteParser.DimensionsContext ctx) {
    ...
    @Override
    public void exitExtendableExpression(CoreRebecaPropertyCompleteParser.ExtendableExpressionContext ctx) {
        Expression e = ctx.coreExpression().e ;
        for (int i = 0; i < ctx.primary().size(); i++) {
            CoreRebecaPropertyCompleteParser.PrimaryContext primaryCtx = ctx.primary(i);
    ...
    @Override
    public void exitCoreExpression(CoreRebecaPropertyCompleteParser.CoreExpressionContext ctx) {
        Expression e;
    ...
    @Override
    public void exitRebecInstantiationExpression(CoreRebecaPropertyCompleteParser.RebecInstantiationExpressionContext ctx){
        ...
        for(CoreRebecaPropertyCompleteParser.ExpressionListContext expressionListContext : ctx.expressionList()) {
            e.getBindings().addAll(expressionListContext.el);
        }
        ctx.e = e;
    }
    @Override
    public void exitAssignmentOperator(CoreRebecaPropertyCompleteParser.AssignmentOperatorContext ctx) {
    ...
    @Override
    public void exitMultiplicativeOp(CoreRebecaPropertyCompleteParser.MultiplicativeOpContext ctx) {
    ...
    @Override
    public void exitAdditiveOp(CoreRebecaPropertyCompleteParser.AdditiveOpContext ctx) {
    ...
    @Override
    public void exitRelationalOp(CoreRebecaPropertyCompleteParser.RelationalOpContext ctx) {
    ...
    @Override
    public void exitShiftOp(CoreRebecaPropertyCompleteParser.ShiftOpContext ctx) {
    ...
    @Override
    public void exitEqualityOp(CoreRebecaPropertyCompleteParser.EqualityOpContext ctx) {
    ...
    @Override
    public void exitUnaryExpression(CoreRebecaPropertyCompleteParser.UnaryExpressionContext ctx) {
    ...
    @Override
    public void exitCastExpression(CoreRebecaPropertyCompleteParser.CastExpressionContext ctx) {
    ...
    @Override
    public void exitPrimary(CoreRebecaPropertyCompleteParser.PrimaryContext ctx) {
        ...
        for (CoreRebecaPropertyCompleteParser.ExpressionContext exprCtx : ctx.expression()) {
    ...
    @Override
    public void exitExpressionList(CoreRebecaPropertyCompleteParser.ExpressionListContext ctx) {
        List<Expression> expressions = new LinkedList<>();
        for (CoreRebecaPropertyCompleteParser.AnnotatedExpressionContext annotatedExpression : ctx.annotatedExpression()) {
            expressions.add(annotatedExpression.e);
        }
        ctx.el = expressions;
    }
    @Override
    public void exitAnnotatedExpression(CoreRebecaPropertyCompleteParser.AnnotatedExpressionContext ctx) {
        List<Annotation> annotationList = new ArrayList<>();
        Expression expr = ctx.expression().e;
        for(CoreRebecaPropertyCompleteParser.AnnotationContext annotation : ctx.annotation()){
    ...
    @Override
    public void exitLiteral(CoreRebecaPropertyCompleteParser.LiteralContext ctx) {
