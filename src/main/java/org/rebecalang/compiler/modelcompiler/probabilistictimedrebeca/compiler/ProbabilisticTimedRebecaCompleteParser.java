...
public class ProbabilisticTimedRebecaCompleteParser extends Parser {
	...
	public static final int
		...
		RULE_switchBlock = 28, RULE_statementExpression = 29, RULE_type = 30, 
		...
		RULE_castExpression = 49, RULE_expressionList = 50, RULE_literal = 51;
	...
	public final PrimaryContext primary() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(284); ((PrimaryContext)_localctx).id1 = match(IDENTIFIER);
			...
			if (_la==LPAREN) {
				{
				setState(286); ((PrimaryContext)_localctx).lp = match(LPAREN);
				...
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << INTLITERAL) | (1L << FLOATLITERAL) | (1L << DOUBLELITERAL) | (1L << CHARLITERAL) | (1L << STRINGLITERAL) | (1L << TRUE) | (1L << FALSE) | (1L << NULL) | (1L << LPAREN) | (1L << BANG) | (1L << TILDA) | (1L << QUES) | (1L << PLUSPLUS) | (1L << SUBSUB) | (1L << PLUS) | (1L << SUB))) != 0) || _la==IDENTIFIER) {
					{
					setState(288); ((PrimaryContext)_localctx).el = expressionList();
				...
				if (_la==AFTER) {
					{
					setState(294); match(AFTER);
					setState(295); match(LPAREN);
					setState(296); ((PrimaryContext)_localctx).ef = expression();
				...
				if (_la==DEADLINE) {
					{
					setState(302); match(DEADLINE);
					setState(303); match(LPAREN);
					setState(304); ((PrimaryContext)_localctx).ed = expression();
			...
			while (_la==LBRACKET) {
				{
				{
				setState(312); match(LBRACKET);
				setState(313); ((PrimaryContext)_localctx).e2 = expression();
				setState(314); match(RBRACKET);
	...
	public final RebecaModelContext rebecaModel() throws RecognitionException {
		...
		try {
			...
			if (_la==PACKAGE) {
				{
				setState(323); ((RebecaModelContext)_localctx).p = packageDeclaration();
			...
			while (_la==IMPORT) {
				{
				{
				setState(328); ((RebecaModelContext)_localctx).i = importDeclaration();
			...
			{
			setState(336); ((RebecaModelContext)_localctx).t1 = rebecaCode();
	...
	public final RebecaCodeContext rebecaCode() throws RecognitionException {
		...
		try {
			...
			while (_la==RECORD) {
				{
				{
				setState(344); ((RebecaCodeContext)_localctx).rd = recordDeclaration();
			...
			{
			setState(352); ((RebecaCodeContext)_localctx).e = environmentVariables();
			...
			do {
				{
				{
				setState(355); ((RebecaCodeContext)_localctx).rcd = reactiveClassDeclaration();
			...
			setState(362); ((RebecaCodeContext)_localctx).md = mainDeclaration();
	...
	public final MainDeclarationContext mainDeclaration() throws RecognitionException {
		...
		try {
			...
			setState(368); ((MainDeclarationContext)_localctx).MAIN = match(MAIN);
			...
			while (_la==IDENTIFIER) {
				{
				{
				setState(371); ((MainDeclarationContext)_localctx).mrd = mainRebecDefinition();
	...
	public final MainRebecDefinitionContext mainRebecDefinition() throws RecognitionException {
		...
		try {
			...
			setState(382); ((MainRebecDefinitionContext)_localctx).t = type();
			setState(383); ((MainRebecDefinitionContext)_localctx).rebecName = match(IDENTIFIER);
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << INTLITERAL) | (1L << FLOATLITERAL) | (1L << DOUBLELITERAL) | (1L << CHARLITERAL) | (1L << STRINGLITERAL) | (1L << TRUE) | (1L << FALSE) | (1L << NULL) | (1L << LPAREN) | (1L << BANG) | (1L << TILDA) | (1L << QUES) | (1L << PLUSPLUS) | (1L << SUBSUB) | (1L << PLUS) | (1L << SUB))) != 0) || _la==IDENTIFIER) {
				{
				setState(386); ((MainRebecDefinitionContext)_localctx).el = expressionList();
			...
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << INTLITERAL) | (1L << FLOATLITERAL) | (1L << DOUBLELITERAL) | (1L << CHARLITERAL) | (1L << STRINGLITERAL) | (1L << TRUE) | (1L << FALSE) | (1L << NULL) | (1L << LPAREN) | (1L << BANG) | (1L << TILDA) | (1L << QUES) | (1L << PLUSPLUS) | (1L << SUBSUB) | (1L << PLUS) | (1L << SUB))) != 0) || _la==IDENTIFIER) {
				{
				setState(394); ((MainRebecDefinitionContext)_localctx).el = expressionList();
	...
	public final EnvironmentVariablesContext environmentVariables() throws RecognitionException {
		...
		try {
			...
			while (_la==ENV) {
				{
				{
				setState(403); match(ENV);
				setState(404); ((EnvironmentVariablesContext)_localctx).fd = fieldDeclaration();
	...
	public final FieldDeclarationContext fieldDeclaration() throws RecognitionException {
		...
		try {
			...
			setState(414); ((FieldDeclarationContext)_localctx).t = type();
			setState(415); ((FieldDeclarationContext)_localctx).vds = variableDeclarators();
	...
	public final VariableDeclaratorsContext variableDeclarators() throws RecognitionException {
		...
		try {
			...
			setState(419); ((VariableDeclaratorsContext)_localctx).vd = variableDeclarator();
	...
	public final VariableDeclaratorContext variableDeclarator() throws RecognitionException {
		...
		try {
			...
			setState(431); ((VariableDeclaratorContext)_localctx).name = match(IDENTIFIER);
			...
			if (_la==EQ) {
				{
				setState(433); match(EQ);
				setState(434); ((VariableDeclaratorContext)_localctx).vi = variableInitializer();
	...
	public final VariableInitializerContext variableInitializer() throws RecognitionException {
		...
		try {
			...
			case LBRACE:
				enterOuterAlt(_localctx, 1);
				{
				setState(439); ((VariableInitializerContext)_localctx).ai = arrayInitializer();
			...
			case IDENTIFIER:
				enterOuterAlt(_localctx, 2);
				{
				setState(442); ((VariableInitializerContext)_localctx).e = expression();
	...
	public final ArrayInitializerContext arrayInitializer() throws RecognitionException {
		...
		try {
			...
			setState(448); ((ArrayInitializerContext)_localctx).LBRACE = match(LBRACE);
			setState(460);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << INTLITERAL) | (1L << FLOATLITERAL) | (1L << DOUBLELITERAL) | (1L << CHARLITERAL) | (1L << STRINGLITERAL) | (1L << TRUE) | (1L << FALSE) | (1L << NULL) | (1L << LPAREN) | (1L << LBRACE) | (1L << BANG) | (1L << TILDA) | (1L << QUES) | (1L << PLUSPLUS) | (1L << SUBSUB) | (1L << PLUS) | (1L << SUB))) != 0) || _la==IDENTIFIER) {
				{
				setState(449); ((ArrayInitializerContext)_localctx).vi = variableInitializer();
	...
	public final ReactiveClassDeclarationContext reactiveClassDeclaration() throws RecognitionException {
		...
		try {
			...
			setState(465); match(REACTIVECLASS);
			setState(466); ((ReactiveClassDeclarationContext)_localctx).reactiveClassName = match(IDENTIFIER);
			...
			setState(469); ((ReactiveClassDeclarationContext)_localctx).queueSize = match(INTLITERAL);
			...
			if (_la==KNOWNREBECS) {
				{
				setState(473); match(KNOWNREBECS);
				setState(474); match(LBRACE);
				setState(481);
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (_la==IDENTIFIER) {
					{
					{
					setState(475); ((ReactiveClassDeclarationContext)_localctx).fd = fieldDeclaration();
			...
			if (_la==STATEVARS) {
				...
				while (_la==IDENTIFIER) {
					{
					{
					setState(489); ((ReactiveClassDeclarationContext)_localctx).fd = fieldDeclaration();
			...
			while (_la==MSGSRV || _la==IDENTIFIER) {
				...
				case 1:
					{
					setState(501); ((ReactiveClassDeclarationContext)_localctx).cd = constructorDeclaration();
				...
				case 2:
					{
					setState(504); ((ReactiveClassDeclarationContext)_localctx).md = msgsrvDeclaration();
				...
				case 3:
					{
					setState(507); ((ReactiveClassDeclarationContext)_localctx).smd = synchMethodDeclaration();
	...
	public final MethodDeclarationContext methodDeclaration(MethodDeclaration md) throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(517); ((MethodDeclarationContext)_localctx).name = match(IDENTIFIER);
			...
			setState(519); ((MethodDeclarationContext)_localctx).fps = formalParameters();
			_localctx.md.getFormalParameters().addAll(((MethodDeclarationContext)_localctx).fps.fps);
			setState(521); ((MethodDeclarationContext)_localctx).b = block();
	...
	public final ConstructorDeclarationContext constructorDeclaration() throws RecognitionException {
		...
		try {
			...
			setState(525); methodDeclaration(_localctx.cd);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final MsgsrvDeclarationContext msgsrvDeclaration() throws RecognitionException {
		...
		try {
			...
			setState(528); match(MSGSRV);
			setState(529); methodDeclaration(_localctx.md);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final SynchMethodDeclarationContext synchMethodDeclaration() throws RecognitionException {
		...
		try {
			...
			setState(532); ((SynchMethodDeclarationContext)_localctx).t = type();
			_localctx.smd.setReturnType(((SynchMethodDeclarationContext)_localctx).t.t);
			setState(534); methodDeclaration(_localctx.smd);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final FormalParametersContext formalParameters() throws RecognitionException {
		...
		try {
			...
			if (_la==IDENTIFIER) {
				{
				setState(538); ((FormalParametersContext)_localctx).fpds = formalParametersDeclaration();
	...
	public final FormalParametersDeclarationContext formalParametersDeclaration() throws RecognitionException {
		...
		try {
			...
			setState(546); ((FormalParametersDeclarationContext)_localctx).fpd = formalParameterDeclaration();
			...
			while (_la==COMMA) {
				...
				setState(549); ((FormalParametersDeclarationContext)_localctx).fpd = formalParameterDeclaration();
				_localctx.fpds.add(((FormalParametersDeclarationContext)_localctx).fpd.fpd);
				}
				}
				setState(556);
	...
	public final FormalParameterDeclarationContext formalParameterDeclaration() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(557); ((FormalParameterDeclarationContext)_localctx).t = type();
			setState(558); ((FormalParameterDeclarationContext)_localctx).name = match(IDENTIFIER);
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			setState(562); ((BlockContext)_localctx).LBRACE = match(LBRACE);
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << PALT) | (1L << INTLITERAL) | (1L << FLOATLITERAL) | (1L << DOUBLELITERAL) | (1L << CHARLITERAL) | (1L << STRINGLITERAL) | (1L << BREAK) | (1L << CONTINUE) | (1L << FOR) | (1L << IF) | (1L << RETURN) | (1L << SWITCH) | (1L << WHILE) | (1L << TRUE) | (1L << FALSE) | (1L << NULL) | (1L << LPAREN) | (1L << LBRACE) | (1L << SEMI) | (1L << BANG) | (1L << TILDA) | (1L << QUES) | (1L << PLUSPLUS) | (1L << SUBSUB) | (1L << PLUS) | (1L << SUB))) != 0) || _la==IDENTIFIER) {
				{
				{
				setState(564); ((BlockContext)_localctx).s = statement();
	...
	public final ForInitContext forInit() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(574); ((ForInitContext)_localctx).fd = fieldDeclaration();
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(577); ((ForInitContext)_localctx).el = expressionList();
	...
	public final SwitchBlockContext switchBlock() throws RecognitionException {
		...
		try {
			...
			while (_la==CASE || _la==DEFAULT) {
				...
				case CASE:
					{
					setState(584); match(CASE);
					setState(585); ((SwitchBlockContext)_localctx).e = expression();
				...
				case DEFAULT:
					{
					setState(588); ((SwitchBlockContext)_localctx).DEFAULT = match(DEFAULT);
				...
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << PALT) | (1L << INTLITERAL) | (1L << FLOATLITERAL) | (1L << DOUBLELITERAL) | (1L << CHARLITERAL) | (1L << STRINGLITERAL) | (1L << BREAK) | (1L << CONTINUE) | (1L << FOR) | (1L << IF) | (1L << RETURN) | (1L << SWITCH) | (1L << WHILE) | (1L << TRUE) | (1L << FALSE) | (1L << NULL) | (1L << LPAREN) | (1L << LBRACE) | (1L << SEMI) | (1L << BANG) | (1L << TILDA) | (1L << QUES) | (1L << PLUSPLUS) | (1L << SUBSUB) | (1L << PLUS) | (1L << SUB))) != 0) || _la==IDENTIFIER) {
					{
					{
					setState(593); ((SwitchBlockContext)_localctx).st = statement();
	...
	public final StatementExpressionContext statementExpression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(606); ((StatementExpressionContext)_localctx).e = expression();
	...
	public final TypeContext type() throws RecognitionException {
		...
		try {
			...
			setState(610); ((TypeContext)_localctx).typeName = match(IDENTIFIER);
			...
			if (_la==LBRACKET) {
				{
				setState(612); ((TypeContext)_localctx).ds = dimensions();
	...
	public final DimensionsContext dimensions() throws RecognitionException {
		...
		try {
			...
			do {
				...
				setState(619); ((DimensionsContext)_localctx).i = match(INTLITERAL);
				setState(620); match(RBRACKET);
	...
	public final ExpressionContext expression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(626); ((ExpressionContext)_localctx).e1 = conditionalExpression();
			((ExpressionContext)_localctx).e =  ((ExpressionContext)_localctx).e1.e;
			setState(632);
			switch ( getInterpreter().adaptivePredict(_input,48,_ctx) ) {
			case 1:
				{
				setState(628); ((ExpressionContext)_localctx).ao = assignmentOperator();
				setState(629); ((ExpressionContext)_localctx).e2 = expression();
	...
	public final AssignmentOperatorContext assignmentOperator() throws RecognitionException {
		...
		try {
			...
			case EQ:
				enterOuterAlt(_localctx, 1);
				{
				setState(634); ((AssignmentOperatorContext)_localctx).EQ = match(EQ);
			...
			case PLUSEQ:
				enterOuterAlt(_localctx, 2);
				{
				setState(636); ((AssignmentOperatorContext)_localctx).PLUSEQ = match(PLUSEQ);
			...
			case SUBEQ:
				enterOuterAlt(_localctx, 3);
				{
				setState(638); ((AssignmentOperatorContext)_localctx).SUBEQ = match(SUBEQ);
			...
			case STAREQ:
				enterOuterAlt(_localctx, 4);
				{
				setState(640); ((AssignmentOperatorContext)_localctx).STAREQ = match(STAREQ);
			...
			case SLASHEQ:
				enterOuterAlt(_localctx, 5);
				{
				setState(642); ((AssignmentOperatorContext)_localctx).SLASHEQ = match(SLASHEQ);
			...
			case AMPEQ:
				enterOuterAlt(_localctx, 6);
				{
				setState(644); ((AssignmentOperatorContext)_localctx).AMPEQ = match(AMPEQ);
			...
			case BAREQ:
				enterOuterAlt(_localctx, 7);
				{
				setState(646); ((AssignmentOperatorContext)_localctx).BAREQ = match(BAREQ);
			...
			case CARETEQ:
				enterOuterAlt(_localctx, 8);
				{
				setState(648); ((AssignmentOperatorContext)_localctx).CARETEQ = match(CARETEQ);
			...
			case TILDAEQ:
				enterOuterAlt(_localctx, 9);
				{
				setState(650); ((AssignmentOperatorContext)_localctx).TILDAEQ = match(TILDAEQ);
			...
			case PERCENTEQ:
				enterOuterAlt(_localctx, 10);
				{
				setState(652); ((AssignmentOperatorContext)_localctx).PERCENTEQ = match(PERCENTEQ);
			...
			case LTLTEQ:
				enterOuterAlt(_localctx, 11);
				{
				setState(654); ((AssignmentOperatorContext)_localctx).LTLTEQ = match(LTLTEQ);
			...
			case GTGTEQ:
				enterOuterAlt(_localctx, 12);
				{
				setState(656); ((AssignmentOperatorContext)_localctx).GTGTEQ = match(GTGTEQ);
	...
	public final ConditionalExpressionContext conditionalExpression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(660); ((ConditionalExpressionContext)_localctx).e1 = conditionalOrExpression();
			((ConditionalExpressionContext)_localctx).e =  ((ConditionalExpressionContext)_localctx).e1.e;
			setState(668);
			switch ( getInterpreter().adaptivePredict(_input,50,_ctx) ) {
			case 1:
				{
				setState(662); match(QUES);
				setState(663); ((ConditionalExpressionContext)_localctx).e2 = expression();
				setState(664); match(COLON);
				setState(665); ((ConditionalExpressionContext)_localctx).e3 = conditionalExpression();
	...
	public final ConditionalOrExpressionContext conditionalOrExpression() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(670); ((ConditionalOrExpressionContext)_localctx).e1 = conditionalAndExpression();
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					{
					{
					setState(672); ((ConditionalOrExpressionContext)_localctx).BARBAR = match(BARBAR);
					setState(673); ((ConditionalOrExpressionContext)_localctx).e2 = conditionalAndExpression();
					BinaryExpression e3 = new BinaryExpression();
	...
	public final ConditionalAndExpressionContext conditionalAndExpression() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(681); ((ConditionalAndExpressionContext)_localctx).e1 = inclusiveOrExpression();
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					{
					{
					setState(683); ((ConditionalAndExpressionContext)_localctx).AMPAMP = match(AMPAMP);
					setState(684); ((ConditionalAndExpressionContext)_localctx).e2 = inclusiveOrExpression();
					BinaryExpression e3 = new BinaryExpression();
	...
	public final InclusiveOrExpressionContext inclusiveOrExpression() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(692); ((InclusiveOrExpressionContext)_localctx).e1 = exclusiveOrExpression();
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					{
					{
					setState(694); ((InclusiveOrExpressionContext)_localctx).BAR = match(BAR);
					setState(695); ((InclusiveOrExpressionContext)_localctx).e2 = exclusiveOrExpression();
					BinaryExpression e3 = new BinaryExpression();
	...
	public final ExclusiveOrExpressionContext exclusiveOrExpression() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(703); ((ExclusiveOrExpressionContext)_localctx).e1 = andExpression();
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					{
					{
					setState(705); ((ExclusiveOrExpressionContext)_localctx).CARET = match(CARET);
					setState(706); ((ExclusiveOrExpressionContext)_localctx).e2 = andExpression();
					BinaryExpression e3 = new BinaryExpression();
	...
	public final AndExpressionContext andExpression() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(714); ((AndExpressionContext)_localctx).e1 = equalityExpression();
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					{
					{
					setState(716); ((AndExpressionContext)_localctx).AMP = match(AMP);
					setState(717); ((AndExpressionContext)_localctx).e2 = equalityExpression();
					BinaryExpression e3 = new BinaryExpression();
	...
	public static class EqualityExpressionContext extends ParserRuleContext {
		...
		public List<TerminalNode> BANGEQ() { return getTokens(ProbabilisticTimedRebecaCompleteParser.BANGEQ); }
		public List<InstanceOfExpressionContext> instanceOfExpression() {
			return getRuleContexts(InstanceOfExpressionContext.class);
		}
		public List<TerminalNode> EQEQ() { return getTokens(ProbabilisticTimedRebecaCompleteParser.EQEQ); }
		public TerminalNode EQEQ(int i) {
			return getToken(ProbabilisticTimedRebecaCompleteParser.EQEQ, i);
		}
		public InstanceOfExpressionContext instanceOfExpression(int i) {
			return getRuleContext(InstanceOfExpressionContext.class,i);
		}
		public TerminalNode BANGEQ(int i) {
			return getToken(ProbabilisticTimedRebecaCompleteParser.BANGEQ, i);
		}
	...
	public final EqualityExpressionContext equalityExpression() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(725); ((EqualityExpressionContext)_localctx).e1 = instanceOfExpression();
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case EQEQ:
						{
						setState(728); ((EqualityExpressionContext)_localctx).EQEQ = match(EQEQ);
					...
					case BANGEQ:
						{
						setState(730); ((EqualityExpressionContext)_localctx).BANGEQ = match(BANGEQ);
					...
					setState(734); ((EqualityExpressionContext)_localctx).e2 = instanceOfExpression();
	...
	public final InstanceOfExpressionContext instanceOfExpression() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(742); ((InstanceOfExpressionContext)_localctx).e1 = relationalExpression();
	...
	public final RelationalExpressionContext relationalExpression() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(745); ((RelationalExpressionContext)_localctx).e1 = shiftExpression();
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					{
					{
					setState(747); ((RelationalExpressionContext)_localctx).ro = relationalOp();
					setState(748); ((RelationalExpressionContext)_localctx).e2 = shiftExpression();
					BinaryExpression e3 = new BinaryExpression();
	...
	public final RelationalOpContext relationalOp() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(756); ((RelationalOpContext)_localctx).LT = match(LT);
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(759); ((RelationalOpContext)_localctx).GT = match(GT);
				setState(760); ((RelationalOpContext)_localctx).EQ = match(EQ);
			...
			case 3:
				enterOuterAlt(_localctx, 3);
				{
				setState(762); ((RelationalOpContext)_localctx).LT = match(LT);
			...
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(764); ((RelationalOpContext)_localctx).GT = match(GT);
	...
	public final ShiftExpressionContext shiftExpression() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(768); ((ShiftExpressionContext)_localctx).e1 = additiveExpression();
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					{
					{
					setState(770); ((ShiftExpressionContext)_localctx).so = shiftOp();
					setState(771); ((ShiftExpressionContext)_localctx).e2 = additiveExpression();
					BinaryExpression e3 = new BinaryExpression();
	...
	public final ShiftOpContext shiftOp() throws RecognitionException {
		...
		try {
			...
			case GT:
				enterOuterAlt(_localctx, 2);
				{
				setState(782); match(GT);
				setState(783); match(GT);
				((ShiftOpContext)_localctx).so =  ">>";
				}
				break;
			default:
	...
	public final AdditiveExpressionContext additiveExpression() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(787); ((AdditiveExpressionContext)_localctx).e1 = multiplicativeExpression();
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case PLUS:
						{
						setState(790); ((AdditiveExpressionContext)_localctx).PLUS = match(PLUS);
					...
					case SUB:
						{
						setState(792); ((AdditiveExpressionContext)_localctx).SUB = match(SUB);
					...
					setState(796); ((AdditiveExpressionContext)_localctx).e2 = multiplicativeExpression();
	...
	public final MultiplicativeExpressionContext multiplicativeExpression() throws RecognitionException {
		...
		try {
			...
			enterOuterAlt(_localctx, 1);
			{
			setState(804); ((MultiplicativeExpressionContext)_localctx).e1 = unaryExpression();
			...
			while ( _alt!=2 && _alt!=-1 ) {
				if ( _alt==1 ) {
					...
					case STAR:
						{
						setState(807); ((MultiplicativeExpressionContext)_localctx).STAR = match(STAR);
					...
					case SLASH:
						{
						setState(809); ((MultiplicativeExpressionContext)_localctx).SLASH = match(SLASH);
					...
					case PERCENT:
						{
						setState(811); ((MultiplicativeExpressionContext)_localctx).PERCENT = match(PERCENT);
					...
					setState(815); ((MultiplicativeExpressionContext)_localctx).e2 = unaryExpression();
	...
	public final UnaryExpressionContext unaryExpression() throws RecognitionException {
		...
		try {
			...
			case PLUS:
				enterOuterAlt(_localctx, 1);
				{
				setState(823); match(PLUS);
				setState(824); ((UnaryExpressionContext)_localctx).ep = unaryExpression();
			...
			case SUB:
				enterOuterAlt(_localctx, 2);
				{
				setState(827); ((UnaryExpressionContext)_localctx).SUB = match(SUB);
				setState(828); ((UnaryExpressionContext)_localctx).es = unaryExpression();
			...
			case PLUSPLUS:
				enterOuterAlt(_localctx, 3);
				{
				setState(831); ((UnaryExpressionContext)_localctx).PLUSPLUS = match(PLUSPLUS);
				setState(832); ((UnaryExpressionContext)_localctx).epp = unaryExpression();
			...
			case SUBSUB:
				enterOuterAlt(_localctx, 4);
				{
				setState(835); ((UnaryExpressionContext)_localctx).SUBSUB = match(SUBSUB);
				setState(836); ((UnaryExpressionContext)_localctx).ess = unaryExpression();
			...
			case IDENTIFIER:
				enterOuterAlt(_localctx, 5);
				{
				setState(839); ((UnaryExpressionContext)_localctx).eu = unaryExpressionNotPlusMinus();
	...
	public final CastExpressionContext castExpression() throws RecognitionException {
		...
		try {
			...
			setState(845); ((CastExpressionContext)_localctx).t = type();
			setState(846); match(RPAREN);
			setState(847); ((CastExpressionContext)_localctx).e1 = expression();
	...
	public final ExpressionListContext expressionList() throws RecognitionException {
		...
		try {
			...
			setState(851); ((ExpressionListContext)_localctx).e = expression();
			...
			while (_la==COMMA) {
				...
				setState(854); ((ExpressionListContext)_localctx).e = expression();
				_localctx.el.add(((ExpressionListContext)_localctx).e.e);
				}
				}
				setState(861);
	...
	public final LiteralContext literal() throws RecognitionException {
		...
		try {
			...
			case INTLITERAL:
				enterOuterAlt(_localctx, 1);
				{
				setState(862); ((LiteralContext)_localctx).INTLITERAL = match(INTLITERAL);
			...
			case FLOATLITERAL:
				enterOuterAlt(_localctx, 2);
				{
				setState(864); ((LiteralContext)_localctx).FLOATLITERAL = match(FLOATLITERAL);
			...
			case DOUBLELITERAL:
				enterOuterAlt(_localctx, 3);
				{
				setState(866); ((LiteralContext)_localctx).DOUBLELITERAL = match(DOUBLELITERAL);
			...
			case CHARLITERAL:
				enterOuterAlt(_localctx, 4);
				{
				setState(868); ((LiteralContext)_localctx).CHARLITERAL = match(CHARLITERAL);
			...
			case STRINGLITERAL:
				enterOuterAlt(_localctx, 5);
				{
				setState(870); ((LiteralContext)_localctx).STRINGLITERAL = match(STRINGLITERAL);
			...
			case TRUE:
				enterOuterAlt(_localctx, 6);
				{
				setState(872); ((LiteralContext)_localctx).TRUE = match(TRUE);
			...
			case FALSE:
				enterOuterAlt(_localctx, 7);
				{
				setState(874); ((LiteralContext)_localctx).FALSE = match(FALSE);
			...
			case NULL:
				enterOuterAlt(_localctx, 8);
				{
				setState(876); ((LiteralContext)_localctx).NULL = match(NULL);
	...
	public static final String _serializedATN =
		...
		"\u011d\13\5\3\6\3\6\3\6\3\6\3\6\3\6\3\6\5\6\u0126\n\6\3\6\3\6\3\6\3\6"+
		"\3\6\3\6\3\6\5\6\u012f\n\6\3\6\3\6\3\6\3\6\3\6\3\6\5\6\u0137\n\6\5\6\u0139"+
		"\n\6\3\6\3\6\3\6\3\6\3\6\7\6\u0140\n\6\f\6\16\6\u0143\13\6\3\7\3\7\3\7"+
		"\3\7\5\7\u0149\n\7\3\7\3\7\3\7\7\7\u014e\n\7\f\7\16\7\u0151\13\7\3\7\3"+
		"\7\3\7\3\b\3\b\3\t\3\t\3\n\3\n\3\n\3\n\7\n\u015e\n\n\f\n\16\n\u0161\13"+
		"\n\3\n\3\n\3\n\3\n\3\n\3\n\6\n\u0169\n\n\r\n\16\n\u016a\3\n\3\n\3\n\3"+
		"\13\3\13\3\f\3\f\3\f\3\f\3\f\3\f\3\f\7\f\u0179\n\f\f\f\16\f\u017c\13\f"+
		"\3\f\3\f\3\r\3\r\3\r\3\r\3\r\3\r\3\r\3\r\5\r\u0188\n\r\3\r\3\r\3\r\3\r"+
		"\3\r\3\r\5\r\u0190\n\r\3\r\3\r\3\r\3\16\3\16\3\16\3\16\3\16\3\16\7\16"+
		"\u019b\n\16\f\16\16\16\u019e\13\16\3\17\3\17\3\17\3\17\3\17\3\20\3\20"+
		"\3\20\3\20\3\20\3\20\3\20\7\20\u01ac\n\20\f\20\16\20\u01af\13\20\3\21"+
		"\3\21\3\21\3\21\3\21\3\21\3\21\5\21\u01b8\n\21\3\22\3\22\3\22\3\22\3\22"+
		"\3\22\5\22\u01c0\n\22\3\23\3\23\3\23\3\23\3\23\3\23\3\23\3\23\7\23\u01ca"+
		"\n\23\f\23\16\23\u01cd\13\23\5\23\u01cf\n\23\3\23\3\23\3\24\3\24\3\24"+
		"\3\24\3\24\3\24\3\24\3\24\3\24\3\24\3\24\3\24\3\24\3\24\3\24\7\24\