 ...
 *         &lt;element name="featureVariables" type="{http://rebecalang.org/compiler/modelcompiler/corerebeca}FieldDeclaration" maxOccurs="unbounded" minOccurs="0"/>
...
public class RebecaCode {
    ...
    protected List<FieldDeclaration> featureVariables;
    ...
    /**
     * Gets the value of the featureVariables property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the featureVariables property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFeatureVariables().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<FieldDeclaration> getFeatureVariables() {
        if (featureVariables == null) {
            featureVariables = new ArrayList<FieldDeclaration>();
        }
